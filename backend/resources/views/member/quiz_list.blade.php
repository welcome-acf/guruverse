...
@section('title', ucwords(str_replace('_', ' ', 'quiz_list')))

@section('content')

<div class="page active" id="page-quiz-list" style="background:var(--c-bg); min-height:100vh; padding-top:0 !important;">
