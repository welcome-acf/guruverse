...
@section('title', ucwords(str_replace('_', ' ', 'diskusi')))

@section('content')

<!-- $discussions sudah di-passing secara otomatis dari Controller menggunakan Eloquent -->
<div class="page active" id="page-diskusi">
<style>
/* ── Diskusi Page Styles ───────────────────── */
.diskusi-hero {
  ...
  <div>
    ...
    <div class="topic-list" id="topicList">
      ...
      @foreach ($discussions as $d)
        @php
          $author_name = $d->member ? $d->member->full_name : 'Member';
  ...
  <div class="diskusi-sidebar">
    ...
    <div class="dsk-card">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        @foreach (['Gunakan bahasa yang sopan & positif', 'Saling menghargai setiap pendapat', 'Hindari konten SARA dan spam', 'Berikan sumber jika berbagi materi'] as $rule)
    ...
    <div class="dsk-card">
      ...
      <div class="tag-cloud">
        @foreach (['Kurikulum Merdeka','RPP','P5','HOTS','Literasi Digital','Asesmen','Diferensiasi','Numerasi','PMM'] as $tag)
