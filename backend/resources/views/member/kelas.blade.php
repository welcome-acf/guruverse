...
@section('title', ucwords(str_replace('_', ' ', 'kelas')))

@section('content')

<!-- $enrollments, $available_courses, $total_kelas, $kelas_selesai sudah di-passing secara otomatis dari Controller menggunakan Eloquent -->
<div class="page active" id="page-kelas">
  <style>
