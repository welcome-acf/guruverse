...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Nunito', 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        .option-btn { background: #fff; border: 3px solid #e2e8f0; border-radius: 16px; padding: 24px; font-size: 1.25rem; font-weight: 700; color: #334155; cursor: pointer; transition: all 0.2s; text-align: left; position: relative; overflow: hidden; display: flex; align-items: center; gap: 16px; width: 100%; }
