...
<main class="law-container">
  ...
  <a href="{{ route('home') }}" class="btn-back-modern">
    ...
    <div class="hero-visuals">
      ...
      <div class="floating-card fc-2">
        <div class="fc-img-wrapper">
          <img src="{{ asset('asset/img/ki_hajar_dewantara.png') }}" alt="Ki Hajar" onerror="this.src='{{ asset('asset/img/FA Logo Guruverse.ID - main.png') }}'">
        </div>
        <div>
  ...
  <section class="section-block">
    <div class="info-section-header" style="text-align: right;">
      <h2 class="info-section-title">
        Karakteristik <span class="hero-highlight">Utama</span>
      </h2>
      <p class="info-section-subtitle" style="margin-left: auto;">
      ...
      <div style="position: relative; height: 100%; min-height: 350px;">
        ...
        <div class="floating-card" style="bottom: 20px; right: 20px; width: 240px; z-index: 4; display:flex; gap:12px; align-items:center;">
          <div class="fc-img-wrapper" style="width: 40px; height: 40px;">
            <img src="{{ asset('asset/img/community_teachers_muslim (2).png') }}" alt="Komunitas" onerror="this.style.display='none'">
          </div>
          <div>
    ...
    <div class="story-card">
      <div class="info-section-header">
        ...
        <div style="text-align:center;">
          <h2 class="info-section-title"><span class="hero-highlight">Ki Hajar Dewantara</span></h2>
        </div>
      </div>
      ...
      <div class="story-grid" style="margin-top: 24px;">
        ...
        <div>
          <div style="display:flex; align-items:center; gap: 16px; margin-bottom: 24px;">
            <img src="{{ asset('asset/img/ki_hajar_dewantara.png') }}" alt="Ki Hajar Dewantara" onerror="this.style.display='none'" style="width: 80px; height: 80px; border-radius: 50%; border: 1px solid var(--law-border); box-shadow: 0 10px 20px rgba(0,0,0,0.1); object-fit: cover;">
            <div>
              <h3 style="font-size: 1.1rem; font-weight: 700; margin:0 0 6px;">Tokoh Pendidikan</h3>
        ...
        <div>
          <h3 style="font-size: 1.1rem; font-weight: 700; margin: 0 0 24px;">Tiga Filosofi Pendidikan</h3>
