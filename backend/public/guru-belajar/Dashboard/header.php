...
<title>Guruverse.ID Semesta Kompetensi Guru Indonesia</title>
...
/* ── Light Mode (toggle from dark default) - Creative Violet (Logo Theme) ── */
[data-theme="light"] {
...
/* Dark mode toggle button (in dark navbar) */
.theme-toggle-btn {
...
/* In light mode (data-theme=light), show moon; default dark page shows sun */
...
.nav-logo{font-size:20px;font-weight:900;color:#fff;letter-spacing:.04em;cursor:pointer}
.nav-logo em{font-style:normal;color:var(--purple-light)}
.nav-links{display:flex;align-items:center;gap:6px}
.nav-link{color:var(--text-muted);font-size:13px;font-weight:500;padding:7px 14px;border-radius:8px;cursor:pointer;transition:all .2s;border:none;background:none;font-family:inherit}
.nav-link:hover{color:#fff;background:rgba(124,58,237,.12)}
.nav-cta{
...
.detail-navbar .nav-link:hover{
  color:#fff!important;background:rgba(124,58,237,.12)!important;
}
...
.step-title{font-size:12px;font-weight:800;color:#e8e4ff;margin-bottom:5px}
