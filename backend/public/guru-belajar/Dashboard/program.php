...
<html lang="id">
<head>
<title>Program — Guruverse.ID</title>
...
.pill-icon-box.belajar-bg { background: var(--prog-blue-bg); }
.pill-icon-box.mengajar-bg { background: var(--prog-orange-bg); }
.pill-icon-box.inspira-bg { background: var(--prog-pink-bg); }
...
.pillar-column-card:hover {
  transform: translateY(-8px);
  box-shadow: 0 15px 35px rgba(0,0,0,0.06);
}
.pillar-column-card.belajar { border-top-color: var(--prog-blue); }
.pillar-column-card.mengajar { border-top-color: var(--prog-orange); }
.pillar-column-card.inspira { border-top-color: var(--prog-pink); }

.myPillarSwiper .swiper-pagination-bullet {
...
.myPillarSwiper .swiper-pagination-bullet-active {
  background: var(--prog-blue);
  transform: scale(1.3);
  opacity: 1;
}
.myPillarSwiper .swiper-button-next,
.myPillarSwiper .swiper-button-prev {
  color: var(--prog-blue);
  background: var(--p-card-bg);
  width: 48px;
  height: 48px;
...
.myPillarSwiper .swiper-button-next::after,
.myPillarSwiper .swiper-button-prev::after {
  font-size: 20px;
  font-weight: bold;
}
.myPillarSwiper .swiper-button-next:hover,
.myPillarSwiper .swiper-button-prev:hover {
  background: var(--prog-blue);
  color: #fff;
}
...
.pillar-column-card.belajar .p-col-badge { color: var(--prog-blue); }
.pillar-column-card.mengajar .p-col-badge { color: var(--prog-orange); }
.pillar-column-card.inspira .p-col-badge { color: var(--prog-pink); }
...
.pillar-column-card.belajar .p-feat-icon { background: var(--prog-blue-bg); color: var(--prog-blue); }
.pillar-column-card.mengajar .p-feat-icon { background: var(--prog-orange-bg); color: var(--prog-orange); }
.pillar-column-card.inspira .p-feat-icon { background: var(--prog-pink-bg); color: var(--prog-pink); }
...
.pillar-column-card.belajar .p-col-quote { background: rgba(37, 99, 235, 0.05); border-left: 4px solid var(--prog-blue); color: var(--prog-blue); }
.pillar-column-card.mengajar .p-col-quote { background: rgba(245, 158, 11, 0.05); border-left: 4px solid var(--prog-orange); color: var(--prog-orange); }
.pillar-column-card.inspira .p-col-quote { background: rgba(236, 72, 153, 0.05); border-left: 4px solid var(--prog-pink); color: var(--prog-pink); }
...
.pillar-column-card.belajar .p-col-btn { background: var(--prog-blue); }
.pillar-column-card.belajar .p-col-btn:hover { background: var(--prog-blue-hover); }
.pillar-column-card.mengajar .p-col-btn { background: var(--prog-orange); }
.pillar-column-card.mengajar .p-col-btn:hover { background: var(--prog-orange-hover); }
.pillar-column-card.inspira .p-col-btn { background: var(--prog-pink); }
.pillar-column-card.inspira .p-col-btn:hover { background: var(--prog-pink-hover); }
...
.closing-avatar-left {
  ...
  z-index: 1;
  pointer-events: none;
  /* Smoothly fade the right edge of the image into the blue background */
...
@media (max-width: 1024px) {
  ...
  .closing-avatar-left, .closing-avatar-right {
    display: none;
  }
  .closing-banner-custom {
    padding: 48px 24px;
  ...
  <div class="container-inner">
    ...
    <section class="hero-section-custom">
      ...
      <div class="hero-image-area">
        <img src="../../asset/img/hero-teachers.png" class="hero-main-img" alt="Guruverse Teachers">
      </div>
    </section>
        ...
        <div class="swiper-slide swiper-slide-custom">
          <div class="pslide-inner belajar-slide">
            ...
            <div class="pslide-actions">
              ...
              <a href="../../register/learn-more-belajar.php" class="pslide-btn" style="background:#2563eb; color:#fff;">Mulai Belajar</a>
            </div>
        ...
        <div class="swiper-slide swiper-slide-custom">
          <div class="pslide-inner mengajar-slide">
            ...
            <div class="pslide-actions">
              ...
              <a href="../../register.php" class="pslide-btn" style="background:#f59e0b; color:#fff;">Mulai Mengajar</a>
            </div>
    ...
    <div class="closing-banner-custom">
      <img src="../../asset/img/modern_teacher_illustration.jfif" class="closing-avatar-left" alt="Teacher Left">
      <div class="closing-content">
        ...
        <button class="closing-action-btn" onclick="window.location.href='../../register/register.php'">
...
.belajar-slide { background: linear-gradient(135deg, var(--card), var(--prog-blue-bg)); }
.mengajar-slide { background: linear-gradient(135deg, var(--card), var(--prog-orange-bg)); }
.inspira-slide { background: linear-gradient(135deg, var(--card), var(--prog-pink-bg)); }

.pslide-title, .pslide-features span { color: var(--text) !important; }
.pslide-desc { color: var(--text-muted) !important; }
...
<script>
  const swiper = new Swiper('.pillarSwiper', {
    effect: 'coverflow',
    grabCursor: true,
    centeredSlides: true,
    slidesPerView: 'auto',
